...
import tech.wetech.flexmodel.domain.model.flow.common.DataType;
...
public class InstanceDataUtil {
  ...
  public static Map<String, tech.wetech.flexmodel.domain.model.flow.model.InstanceData> getInstanceDataMap(List<tech.wetech.flexmodel.domain.model.flow.model.InstanceData> instanceDataList) {
    if (CollectionUtils.isEmpty(instanceDataList)) {
      return Maps.newHashMap();
    }
    Map<String, tech.wetech.flexmodel.domain.model.flow.model.InstanceData> instanceDataMap = Maps.newHashMap();
