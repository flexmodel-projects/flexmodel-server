...
public class FlowModelUtil {
  ...
  public static FlowModel parseModelFromString(String flowModelStr) {
    return tech.wetech.flexmodel.shared.utils.JsonUtils.getInstance().parseToObject(flowModelStr, FlowModel.class);
  }
  ...
  public static String getElementName(FlowElement flowElement) {
    ...
    return Objects.toString(properties.get(Constants.ELEMENT_PROPERTIES.NAME), "");
  }
}
