...
import dev.flexmodel.domain.model.flow.plugin.*;
import dev.flexmodel.domain.model.flow.shared.common.PluginTypeEnum;
...
public class DefaultPluginManager extends AbstractPluginManager {
  ...
  public DefaultPluginManager(CdiBeanProvider beanProvider) {
    ...
    pluginList.forEach(plugin -> {
      try {
        ...
        if (plugin instanceof BasePlugin) {
          ((BasePlugin) plugin).setBeanProvider(beanProvider);
        }
      } catch (Exception e) {
