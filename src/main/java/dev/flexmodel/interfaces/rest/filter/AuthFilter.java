...
import dev.flexmodel.domain.model.auth.AuthException;
...
public class AuthFilter implements ContainerRequestFilter {
  ...
  private boolean varifyWithIdp(ContainerRequestContext requestContext) {
    ...
    dev.flexmodel.domain.model.idp.provider.Provider provider = JsonUtils.getInstance().convertValue(identityProvider.getProvider(), dev.flexmodel.domain.model.idp.provider.Provider.class);
